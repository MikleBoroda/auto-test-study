...
public class JsonDeserialzerTest {
    ...
    private final String ROOM_PATH = "src/main/java/lesson12/task1/room.json";
    private final String FLAT_PATH = "src/main/java/lesson12/task1/flat.json";
    private final String HOUSE_PATH = "src/main/java/lesson12/task1/house.json";
