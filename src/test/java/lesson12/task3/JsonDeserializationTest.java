...
public class JsonDeserializationTest {
    protected final String PERSON_JSON = "src/main/java/lesson12/task3/person.json";
    protected final String PROJECT_JSON = "src/main/java/lesson12/task3/project.json";
